<template>
  <div class="footer">
    <div class="footer-content">
      <div class="logo-text">
        <img src="/Logoblack.png" alt="logo" class="logo" />
        <div class="logo-text-description-container">
          <p class="logo-text-description">We are a residential interior design firm located in</p>
          <p class="logo-text-description">Portland. Our boutique-studio offers more than</p>
        </div>
      </div>
      <div class="footer-navigation">
        <div class="section">
          <p class="section-title">Services</p>
          <p class="section-item">Bonus program</p>
          <p class="section-item">Gift cards</p>
          <p class="section-item">Credit and payment</p>
          <p class="section-item">Service contracts</p>
          <p class="section-item">Non-cash account</p>
          <p class="section-item">Payment</p>
        </div>
        <div class="section">
          <p class="section-title">Assistance to the buyer</p>
          <p class="section-item">Find an order</p>
          <p class="section-item">Terms of delivery</p>
          <p class="section-item">Exchange and return of goods</p>
          <p class="section-item">Guarantee</p>
          <p class="section-item">Frequently asked questions</p>
          <p class="section-item">Terms of use of the site</p>
        </div>
      </div>
    </div>
...
.logo-text-description-container {
  display: flex;
  flex-direction: column;
  align-items: flex-start;
}
